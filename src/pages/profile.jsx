import { PencilAltIcon, ThumbUpIcon } from "@heroicons/react/solid";
...
const Profile= () => {
    ...
    return (
      ...
      <div className="p-2 shadow flex flex-col gap-4 md:flex-row items-center">
        ...
        <div className="flex">
          <button className="rounded-l bg-blue-800 text-white px-2 py-1 hover:shadow flex items-center">
            <PencilAltIcon className="h-4" />
            <p>Edit Profile</p>
          </button>
          <button className="rounded-r bg-blue-700 text-white px-2 py-1 hover:shadow flex items-center">
      ...
      <div>
        <h1 className=" font-semibold text-lg my-4">My Posts</h1>
